...
const ListaRestaurantes = () => {
  ...
  useEffect(()=> {
    axios.get<IPaginacao<IRestaurante>>('https://reqres.in/api/users') //http://localhost:8000/api/v1/restaurantes/${restaurante.id}/pratos/
      .then( resposta => {
  ...
  const verMais = () => {
    ...
    .then( resposta => {
      // setRestaurante[s(resposta.data.results)
